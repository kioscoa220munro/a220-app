...
(function(){
  ...
  const css=`.a220-quick-offers{margin-top:12px}.a220-quick-title{display:flex;justify-content:space-between;align-items:center;font-weight:900;font-size:14px;margin:8px 0}.a220-quick-title span{font-size:12px;opacity:.65}.a220-quick-list{display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:7px}.a220-quick-offer{width:100%;display:flex;align-items:center;gap:9px;text-align:left;padding:11px;border:1px solid #9fc6ec;border-radius:9px;background:#f3f8ff;cursor:pointer;font:inherit}.a220-quick-offer:hover{transform:translateY(-1px);box-shadow:0 4px 12px #00000012}.a220-quick-icon{font-size:21px}.a220-quick-info{min-width:0;flex:1}.a220-quick-info strong,.a220-quick-info small{display:block;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.a220-quick-info strong{font-size:14px}.a220-quick-info small{font-size:11px;opacity:.65;margin-top:2px}.a220-quick-price{font-size:14px;font-weight:900;white-space:nowrap}@media(max-width:480px){.a220-quick-list{grid-template-columns:1fr}}`;
