...
(function(){
  function apply(){
    ...
    if(actions){
      ...
      if(buttons[0]){buttons[0].textContent='Establecer precio';buttons[0].onclick=()=>chooseReferencePrice()}
